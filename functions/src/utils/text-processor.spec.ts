...
describe('Text processor', () => {
  describe('Convert full-width characters into half-width', () => {
    test('should be converted successfully', () => {
  ...
  describe('Unify text format', () => {
    test('should be unified successfully', () => {
  ...
  describe('Normalize raw text into flat for matching', () => {
    test('should be converted successfully with hira2kata', () => {
  ...
  describe('Chop raw text roughly', () => {
    test('should be chopped successfully', () => {
  ...
  describe('Tokenize text for full-text search', () => {
    test('should be tokenized successfully', () => {
      const text = '奥 浩哉';
      const result = tokenize(text);
      expect(result).toEqual(['奥浩', '浩哉']);
    });
    test('should be tokenized successfully with middle dot', () => {
      const text = '同・級・生!!';
      const result = tokenize(text);
      expect(result).toEqual(['同級', '級生']);
    });
    test('should be tokenized successfully with long ttestle', () => {
